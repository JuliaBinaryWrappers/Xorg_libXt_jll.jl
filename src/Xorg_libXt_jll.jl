...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Xorg_libXt_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("28c4a263-0105-5ca0-9a8c-f4f6b89a1dd4"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Xorg_libXt", artifacts_toml) for e in artifacts["Xorg_libXt"]]
...
if best_platform === nothing
    @debug("Unable to load Xorg_libXt; unsupported platform $(triplet(platform_key_abi()))")
else
